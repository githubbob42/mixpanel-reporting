 ...
 * @requires jquery
 */
define(['durandal/system', 'durandal/activator', 'durandal/events', 'durandal/composition', 'plugins/history', 'knockout', 'jquery'], function(system, activator, events, composition, history, ko, $) {
    var optionalParam = /\((.*?)\)/g;
    var namedParam = /(\(\?)?:\w+/g;
    var splatParam = /\*\w+/g;
    ...
    var trailingSlash = /\/$/;
    var activeRouteParams = ko.observable();
    ...
    var createRouter = function() {
        ...
        function completeNavigation(instance, instruction) {
            ...
            activeRouteParams(instruction.params);
        ...
        function mapRoute(config) {
            ...
            router.route(config.routePattern, function(fragment, queryString) {
                ...
                while ((path_match = PATH_NAME_MATCHER.exec(config.route)) !== null) {
                    param_names.push(path_match[1]);
                    params[path_match[1]] = paramInfo.params[param_names.indexOf(path_match[1])];
                }
        ...
        /**
         * Replace the current window location with the provided URL.
         * @method redirect
         * @param {string} url The url or fragment to navigate to.
         */
        router.redirect = function(url) {
            system.log('Navigation Reload/Redirecting');
        ...
        router.navigate = function(fragment, options) {
            ...
            return history.navigate(fragment, options || { trigger: true });
        };
    ...
    rootRouter.explicitNavigation = false;
    rootRouter.navigatingBack = false;
    rootRouter.activeRouteParams = activeRouteParams;
    ...
    rootRouter.disable = function() {
        history.active = false;
    };

    rootRouter.enable = function() {
        history.active = true;
    }
